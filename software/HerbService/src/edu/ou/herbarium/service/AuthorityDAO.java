 ...
 * 
 * @see edu.ou.herbarium.service.Authority
...
public class AuthorityDAO extends BaseHibernateDAO {
	...
	public static final String AUTHORITY_TAB_CLASS = "authorityTabClass";
	...
	public Authority findById(java.lang.Integer id) {
		...
		try {
			Authority instance = (Authority) getSession().get(
					"edu.ou.herbarium.service.Authority", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Authority instance) {
		...
		try {
			List results = getSession()
					.createCriteria("edu.ou.herbarium.service.Authority")
	...
	public List findByAuthorityTabClass(Object authorityTabClass) {
		return findByProperty(AUTHORITY_TAB_CLASS, authorityTabClass);
	}
