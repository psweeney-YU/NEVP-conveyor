...
@XmlType(name = "specimen", propOrder = { "barcode", "beginEventDate",
		"checksum", "collection", "collectionCode", "collectorNotes",
		"country", "county", "creationDate", "darwinCountry", "endEventDate",
		"exportDate", "family", "folderName", "folderNumber", "generalNotes",
		"genus", "handler", "herbarium", "identificationQualifier",
		"idropSync", "imageData", "imageError", "imagePath", "imageRaw",
		"infraspecificEpithet", "infraspecificRank", "missingInfo",
		"modificationDate", "recordDate", "recordEnterBy", "recordNumber",
		"recordedByGuid", "scientificName", "scientificNameAuthorship",
		"sheetNotes", "specCollectorMaps", "specificEpithet", "specimenId",
		"specimenType", "stateProvince", "storageLocation", "system", "town",
		"user", "verbatimEventDate", "watermark", "watermarkDate",
		"writtenNumber" ,"tempData", "folderPath","workspace","isFolder","isNext"})
